...
export default function LoginPage() {
  ...
  const loginUser = async (e) => {
    ...
    try {
      ...
      console.log("User_Role", res.data.user_role);
      ...
      if (res.data.user_role === "ROLE_VENDER") {
        navigate("/");
      } else if (res.data.user_role === "ROLE_VENDOR") {
        navigate("/adminhome");
      ...
      <div className= "bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={loginUser}>
            ...
            <div className= "input">
              ...
              <input type ="text"  placeholder="Username" className="input-et" value={username} onChange={ev => setUsername(ev.target.value)}/>
            </div>
